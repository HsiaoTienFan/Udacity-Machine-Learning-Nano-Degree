    ...
    def createQ(self, state):
        ...
        if self.learning == True:
            if state not in self.Q:
                self.Q[state] = {}
                for action_choice in self.valid_actions:
                    self.Q[state][action_choice] = 0.0
        return
    ...
    def choose_action(self, state):
        ...
        if self.learning == False:
            ...
            if chance < self.epsilon:
                ...
                choices = [choice for choice, value in self.Q[state].items() if value == self.get_maxQ(state)]
